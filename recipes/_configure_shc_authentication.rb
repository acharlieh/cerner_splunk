...
hash = CernerSplunk::DataBag.load node['splunk']['config']['authentication'], pick_context: ['shc_configs']
...
splunk_template 'shcluster/deployer-configs/authentication.conf' do
